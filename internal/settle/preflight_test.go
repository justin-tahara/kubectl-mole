...
func TestPreflightNotFound(t *testing.T) {
	...
	err := preflight(context.Background(), cs, Target{Kind: KindDeployment, Namespace: "prod", Name: "api"})
...
func TestPreflightForbiddenWorkload(t *testing.T) {
	...
	err := preflight(context.Background(), cs, Target{Kind: KindStatefulSet, Namespace: "prod", Name: "db"})
